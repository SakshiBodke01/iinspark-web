...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#061224] text-slate-300 border-t border-white/10 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-10 lg:px-12 pt-16 md:pt-20 pb-8 max-w-7xl">
        ...
        {/* ── 4-Column Grid with Increased Breathing Room ── */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14 mb-14">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-block group">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col justify-center">
                  <span className="font-heading font-extrabold text-base sm:text-lg text-white tracking-tight leading-none">
                    IINSPARK
                  </span>
            ...
            {/* Interactive Social Links with Spring Scale Animation */}
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                rel="noreferrer"
                aria-label="Facebook"
                className="w-9 h-9 rounded-full bg-white/10 border border-white/15 text-slate-300 flex items-center justify-center transition-all duration-200 hover:bg-[#F2A900] hover:border-[#F2A900] hover:text-[#061224] hover:scale-110 active:scale-95 shadow-sm"
              >
          ...
          <div>
            <h4 className="font-bold text-xs uppercase tracking-wider text-white mb-4 flex items-center gap-2">
              <span className="inline-block w-1 h-3.5 rounded-full bg-[#F2A900] shadow-xs" />
              Quick Links
            </h4>
        ...
        {/* Fading Gradient Separator Line */}
        <div aria-hidden="true" className="h-[1px] w-full bg-gradient-to-r from-transparent via-white/15 to-transparent mb-6" />
